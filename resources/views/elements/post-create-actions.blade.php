<div class="d-flex flex-column flex-md-row">
    ...
    <!-- <div class="mt-1">
        ...
        >
            ...
            <img src="/img/files-wht.png" alt="{{__('Files')}}">
    ...
    <div class="mt-1 ml-0 ml-md-2">
        ...
        >
           ...
           <img src="/img/price-wht.png" alt="{{__('Price')}}">
    ...
    @if(Route::currentRouteName() == 'posts.create')
        <div class="mt-1 ml-0 ml-md-5">
            <a href="#" class="draft-clear-button mr-2 mr-md-2">{{__('Clear draft')}}</a>
        </div>
    @endif
     @if(!GenericHelper::isUserVerified() && getSetting('site.enforce_user_identity_checks'))
        <button class="btn btn-outline-primary disabled mb-0 mt-1">{{__('Publish Post')}}</button>
    @else
        <button class="btn btn-outline-primary post-create-button mb-0 mt-1 pnkbtn">{{__('Publish Post')}}</button>
    @endif
