...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="top-dash">
                <div class="dettl">Welcome to your FANCCI Dashboard</div>
                <div class="deb-cont">
                <div class="dash-ebox">
                    <h3>356</h3>
                    <h4>Partners in your <br>FANCCI Network</h4>
                    <a href="#">Details</a>
                </div>
                <div class="dash-ebox">
                    <h3>1'224 USD</h3>
                    <h4>Creator Profit</h4>
                    <a href="#">Details</a> <a href="#">Cashout</a>
                </div>
                <div class="dash-ebox">
                    <h3>2'886 USD</h3>
                    <h4>Network Commision</h4>
                    <a href="#">Details</a> <a href="#">Cashout</a>
                </div>
                </div>
                ...
                @if(GenericHelper::isEmailEnforcedAndValidated())
                    <a role="button" href="{{route('posts.create')}}"><i class="fa fa-pencil-square-o"></i> Create new Post</a>
                @endif
                @endif
                    <a href="#"><i class="fa fa-id-badge"></i> Create new Gallery</a>
                    <a href="{{route('my.settings')}}"><i class="fa fa-id-card"></i> Manage my Profile</a>
                </div>
