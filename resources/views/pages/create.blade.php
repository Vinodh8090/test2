    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="pl-3 pr-3 pt-2">
                ...
                @endif
                <div class="d-flex flex-column-reverse pstbtn">
                    <div class="w-100">
                        <textarea  id="dropzone-uploader" name="input-text" class="form-control border w-100" rows="3" spellcheck="false" placeholder="{{__('Write a new post')}}" value="{{isset($post) ? $post->text : ''}}"></textarea>
                        <span class="invalid-feedback" role="alert">
                            <strong class="post-invalid-feedback">{{__('Your post must contain more than 10 characters.')}}</strong>
                        </span>

                        <div class="dzbox dropzone">
                        <div class="dz-default dz-message">
                            <span><strong>Add a picture, video or audio file <br>to your post.</strong><small>Upload, drag & drop it here <br>or paste it here from your clipboard.</small></span>
                        </div>
                        <span class="file-upload-button"></span>
                        </div>
                        <div class="upload-dtls">
                            <h3>File-Size: <strong>Max. 1 GB</strong></h3>
                            <h4>Picture formats: png, jpg, jpeg </h4>
                            <h4>Video formats: mp4, avi, mov, moov, m4v, mpeg, wmv, avi, asf </h4>
                            <h4>Audio formats: wav, mp3, ogg</h4>
                            <p>Pictures and videos will be encoded for optimal online experience. Please note, that the bigger the file, the longer it takes to upload and to encode, depending on your internet connection.</p>
                        </div>
